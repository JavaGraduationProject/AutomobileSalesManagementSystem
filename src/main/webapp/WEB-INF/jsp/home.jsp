...
<body class="easyui-layout">
	...
	<div id="HomeFuncAccordion" class="easyui-accordion" style="width:213px;"
		...
		<div title="车辆管理" data-options="selected:true" style="padding:10px;">
			<ul id="scheduleMonitor" class="easyui-tree" data-options="animate:true,lines:true">
				<li><span>车辆管理</span>
					...
					<ul>
						<li id=13 data-options="attributes:{'url':'product/find'}">车辆信息管理</li>
					</ul>
					<ul>
						<li id=14 data-options="attributes:{'url':'work/find'}">车辆增删改查</li>
					</ul>
					<ul>
						<li id=15 data-options="attributes:{'url':'manufacture/find'}">生产车辆管理</li>
					</ul>
					<ul>
		...
		<div title="服务管理" data-options="selected:true" style="padding:10px">
			<ul id="technologyMonitor" class="easyui-tree" data-options="animate:true,lines:true">
				<li><span>服务管理</span>
					<ul>
						<li id=31 data-options="attributes:{'url':'technology/find'}">生产人管理</li>
						<li id=32 data-options="attributes:{'url':'technologyRequirement/find'}">提醒用户定期保养</li>
						<li id=33 data-options="attributes:{'url':'technologyPlan/find'}">提醒用户定期安检</li>
						<li id=34 data-options="attributes:{'url':'process/find'}">渠道管理</li>
					</ul>
				</li>
			</ul>
		</div>
		...
		<div title="业务管理" data-options="selected:true" style="padding:10px">
			...
			<ul id="materialMonitor" class="easyui-tree" data-options="animate:true,lines:true">
				<li><span>业务管理 </span>
					<ul>
						<li id=41 data-options="attributes:{'url':'material/find'}">车辆销售管理</li>
						<li id=42 data-options="attributes:{'url':'materialReceive/find'}">业务收入</li>
				    	<li id=43 data-options="attributes:{'url':'materialConsume/find'}">汽车进货管理</li>	 					
					</ul>
				</li>
			</ul>
		</div>
		
		<div title="统计分析" data-options="selected:true" style="padding:10px;">
			<ul id="qualifyMonitor" class="easyui-tree"
				...
				<li><span>统计分析</span>
					<ul>
						...
						<li id=54 data-options="attributes:{'url':'p_measure_check/find'}">人员销售数量</li>
						<li id=55 data-options="attributes:{'url':'p_count_check/find'}">热卖汽车类型</li>
					</ul>
				</li>
			</ul>
