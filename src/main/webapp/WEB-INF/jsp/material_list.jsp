...
<table class="easyui-datagrid" id="materialList" title="车辆销售管理" data-options="singleSelect:false,collapsible:true,
	pagination:true,rownumbers:true,url:'material/list',method:'get',pageSize:10,fitColumns:true,
	toolbar:toolbar_material">
    <thead>
         <tr>
        	<th data-options="field:'ck',checkbox:true"></th>
        	<th data-options="field:'materialId',align:'center',width:100">业务编号</th>
            <th data-options="field:'materialType',align:'center',width:100">业务类型</th>
...
<div  id="toolbar_material" style=" height: 22px; padding: 3px 11px; background: #fafafa;">  
    ...
    <div id="search_material" style="float: right;">
        ...
        <div id="menu_material" style="width:120px"> 
			...
			<div data-options="name:'materialType'">业务类型</div> 		
		</div>     
    </div>  

</div>  

<div id="materialEditWindow" class="easyui-window" title="编辑业务" data-options="modal:true,closed:true,resizable:true,
	iconCls:'icon-save',href:'material/edit'" style="width:65%;height:65%;padding:10px;">
</div>
<div id="materialAddWindow" class="easyui-window" title="添加业务" data-options="modal:true,closed:true,resizable:true,
...
function doSearch_material(value,name){ //用户输入用户名,点击搜素,触发此函数  
	if(value == null || value == ''){
		$("#materialList").datagrid({
	        title:'车辆销售管理', singleSelect:false, collapsible:true, pagination:true, rownumbers:true, method:'get',
			nowrap:true, toolbar:"toolbar_material", url:'material/list', method:'get', loadMsg:'数据加载中......',
			fitColumns:true,//允许表格自动缩放,以适应父容器
	        columns : [ [ 	       
				{field : 'ck', checkbox:true },
				{field : 'materialId', width : 100, title : '业务编号', align:'center'},
				{field : 'materialType', width : 100, align : 'center', title : '业务类型'},
				{field : 'status', width : 100, align : 'center', title : '业务状态'},
