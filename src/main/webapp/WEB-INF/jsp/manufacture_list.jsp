...
<table class="easyui-datagrid" id="manufactureList" title="车辆列表" data-options="singleSelect:false,
    ...
    <thead>
        <tr>
        	...
        	<th data-options="field:'manufactureSn',align:'center',width:150">编号</th>
            <th data-options="field:'cOrder',align:'center',width:150,formatter:formatManuOrder">订单</th>
            <th data-options="field:'technology',align:'center',width:150,formatter:formatManuTechnology">生产人</th>
            <th data-options="field:'launchQuantity',align:'center',width:100">生产数量</th>
...
<div  id="toolbar_manufacture" style=" height: 22px; padding: 3px 11px; background: #fafafa;">  
    ...
    <div id="search_manufacture" style="float: right;">
        ...
        <div id="menu_manufacture" style="width:120px"> 
			<div data-options="name:'manufactureSn'">编号</div> 
			<div data-options="name:'manufactureOrderId'">订单编号</div> 
			<div data-options="name:'manufactureTechnologyName'">生产人</div>
		</div>     
    </div>  

</div>  

<div id="manufactureEditWindow" class="easyui-window" title="编辑车辆" data-options="modal:true,closed:true,
	resizable:true,iconCls:'icon-save',href:'manufacture/edit'" style="width:40%;height:60%;padding:10px;">
</div>
<div id="manufactureAddWindow" class="easyui-window" title="添加车辆" data-options="modal:true,closed:true,
...
<div id="manuTechnologyInfo" class="easyui-dialog" title="生产人信息" data-options="modal:true,closed:true,resizable:true,
	...
	if(value == null || value == ''){
		...
		$("#manufactureList").datagrid({
	        ...
	        columns : [ [ 
				...
				{field : 'manufactureSn', width : 150, title : '编号', align:'center'},
				{field : 'cOrder', width : 100, align : 'center', title : '订单', formatter:formatManuOrder},
				{field : 'technology', width : 100, align : 'center', title : '生产人', formatter:formatManuTechnology},
				{field : 'launchQuantity', width : 100, title : '生产数量', align:'center'},
    ...
    function manufacture_delete(){
    	$.get("manufacture/delete_judge",'',function(data){
      		if(data.msg != null){
	        	...
	        	$.messager.confirm('确认','确定删除编号为 '+ids+' 的车辆吗？',function(r){
	        	    if (r){
	        	    	var params = {"ids":ids};
