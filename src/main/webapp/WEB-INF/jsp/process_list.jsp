...
<table class="easyui-datagrid" id="processList" title="车辆列表" data-options="singleSelect:false,collapsible:true,
...
<div  id="toolbar_process" style=" height: 22px; padding: 3px 11px; background: #fafafa;">  
    ...
    <div id="search_process" style="float: right;">
        ...
        <div id="menu_process" style="width:120px"> 
			<div data-options="name:'processId'">车辆编号</div> 
...
<div id="processEditWindow" class="easyui-window" title="编辑车辆" data-options="modal:true,closed:true,resizable:true,
	iconCls:'icon-save',href:'process/edit'" style="width:35%;height:50%;padding:10px;">
</div>
<div id="processAddWindow" class="easyui-window" title="添加车辆" data-options="modal:true,closed:true,resizable:true,
	iconCls:'icon-save',href:'process/add'" style="width:35%;height:50%;padding:10px;">
</div>
 
<!-- 提醒用户定期安检信息 -->
<div id="technologyPlanInfo_process" class="easyui-dialog" title="提醒用户定期安检信息" data-options="modal:true,closed:true,
	...
	if(value == null || value == ''){
		...
		$("#processList").datagrid({
	        ...
	        columns : [ [ 
				...
				{field : 'sequence', width : 100, align : 'center', title : '车辆顺序'},
		...
		$.get("technologyPlan/edit_judge",'',function(data){
    		if(data.msg != null){
    			...
    			$.post("technologyPlan/update_all",$("#technologyPlanEditForm_process").serialize(), function(data){
    				if(data.status == 200){
    					$.messager.alert('提示','修改提醒用户定期安检成功!','info',function(){
