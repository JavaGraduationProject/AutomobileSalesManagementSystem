...
<div style="padding:10px 10px 10px 10px">
	<form id="permissionForm" class="itemForm" method="post"> 
			...
			<label><input name="permissionOption" type="checkbox" value="61" />车辆新增 </label> 
			<label><input name="permissionOption" type="checkbox" value="62" />车辆修改 </label> 
			<label><input name="permissionOption" type="checkbox" value="63" />车辆删除 </label> 
			<br><br>
			<span style="font-weight: bold;">生产车辆管理：</span>
			<label><input name="permissionOption" type="checkbox" value="71" />车辆新增 </label> 
			<label><input name="permissionOption" type="checkbox" value="72" />车辆修改 </label> 
			<label><input name="permissionOption" type="checkbox" value="73" />车辆删除 </label> 
			<br><br>
			...
			<label><input name="permissionOption" type="checkbox" value="91" />生产人新增 </label> 
			<label><input name="permissionOption" type="checkbox" value="92" />生产人修改 </label> 
			<label><input name="permissionOption" type="checkbox" value="93" />生产人删除 </label> 
			<br><br>
			<span style="font-weight: bold;">车辆管理：</span>
			<label><input name="permissionOption" type="checkbox" value="101" />车辆新增 </label> 
			<label><input name="permissionOption" type="checkbox" value="102" />车辆修改 </label> 
			<label><input name="permissionOption" type="checkbox" value="103" />车辆删除 </label> 
			<br><br>
			<span style="font-weight: bold;">提醒用户定期安检管理：</span>
			<label><input name="permissionOption" type="checkbox" value="111" />提醒用户定期安检新增 </label> 
			<label><input name="permissionOption" type="checkbox" value="112" />提醒用户定期安检修改 </label> 
			<label><input name="permissionOption" type="checkbox" value="113" />提醒用户定期安检删除 </label> 
			<br><br>
			<span style="font-weight: bold;">提醒用户定期保养管理：</span>
			<label><input name="permissionOption" type="checkbox" value="121" />提醒用户定期保养新增 </label> 
			<label><input name="permissionOption" type="checkbox" value="122" />提醒用户定期保养修改 </label> 
			<label><input name="permissionOption" type="checkbox" value="123" />提醒用户定期保养删除 </label>  
			<br><br>
			<span style="font-weight: bold;">业务管理：</span>
			<label><input name="permissionOption" type="checkbox" value="181" />业务新增 </label> 
			<label><input name="permissionOption" type="checkbox" value="182" />业务修改 </label> 
			<label><input name="permissionOption" type="checkbox" value="183" />业务删除 </label> 
			<br><br>
			<span style="font-weight: bold;">业务收入管理：</span>
			<label><input name="permissionOption" type="checkbox" value="191" />业务收入新增 </label> 
			<label><input name="permissionOption" type="checkbox" value="192" />业务收入修改 </label> 
			<label><input name="permissionOption" type="checkbox" value="193" />业务收入删除 </label>  
			<br><br>
			<span style="font-weight: bold;">汽车进货管理管理：</span>
			<label><input name="permissionOption" type="checkbox" value="221" />汽车进货管理新增 </label> 
			<label><input name="permissionOption" type="checkbox" value="222" />汽车进货管理修改 </label> 
			<label><input name="permissionOption" type="checkbox" value="223" />汽车进货管理删除 </label> 
			<br><br>
			...
			<label><input name="permissionOption" type="checkbox" value="151" />热卖汽车类型新增 </label> 
			<label><input name="permissionOption" type="checkbox" value="152" />热卖汽车类型修改 </label> 
			<label><input name="permissionOption" type="checkbox" value="153" />热卖汽车类型删除 </label>  
			<br><br>
			<span style="font-weight: bold;">人员销售数量：</span>
			<label><input name="permissionOption" type="checkbox" value="161" />人员销售数量新增 </label> 
			<label><input name="permissionOption" type="checkbox" value="162" />人员销售数量修改 </label> 
			<label><input name="permissionOption" type="checkbox" value="163" />人员销售数量删除 </label>
			<br><br>
