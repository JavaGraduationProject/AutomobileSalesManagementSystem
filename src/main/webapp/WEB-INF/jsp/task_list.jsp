...
<div  id="toolbar_task" style=" height: 22px; padding: 3px 11px; background: #fafafa;">  
    ...
    <div id="search_task" style="float: right;">
        ...
        <div id="menu_task" style="width:120px"> 
			...
			<div data-options="name:'taskWorkId'">工号</div>
			<div data-options="name:'taskManufactureSn'">编号</div> 
		</div>     
    </div>  
...
<div id="taskWorkInfo" class="easyui-dialog" title="车辆信息" data-options="modal:true,closed:true,resizable:true,
...
<div id="taskManufactureInfo" class="easyui-dialog" title="车辆信息" data-options="modal:true,closed:true,
	...
	if(value == null || value == ''){
		...
		$("#taskList").datagrid({
	        ...
	        columns : [ [ 
				...
				{field : 'workId', width : 100, align : 'center', title : '工号', formatter:formatTaskWork},
				{field : 'manufactureSn', width : 100, align : 'center', title : '编号',
